        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-gray-600 max-w-full lg:max-w-2xl">
            ...
            <button
              ...
              className="w-full sm:w-auto px-3 sm:px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center lg:justify-start space-x-2 text-sm sm:text-base"
            >
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-1">
            <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-1">
              <button
                ...
                className={`flex-1 py-2.5 px-3 sm:px-4 rounded-md font-medium transition-all duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base ${
                  activeTab === 'notes'
              ...
              >
                ...
                <span className="hidden sm:inline">Process Content</span>
            ...
            <>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  ...
                  <h2 className="text-base sm:text-lg font-medium text-gray-900">AI Notes</h2>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                {selectedNote ? (
                  <div className="space-y-4 sm:space-y-6">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
                        <span className="bg-blue-100 text-blue-700 text-xs sm:text-sm px-2 sm:px-3 py-1 rounded-full font-medium">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      {/* Summary */}
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Summary</h3>
                        <p className="text-gray-700 bg-gray-50 p-3 sm:p-4 rounded-lg text-xs sm:text-sm">
                      ...
                      {/* Key Points */}
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Key Points</h3>
                      ...
                      {/* Topics */}
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Topics Covered</h3>
                  ...
                  <div className="text-center py-8 sm:py-12">
                    ...
                    <h2 className="text-base sm:text-lg font-medium text-gray-900 mb-2">Select a Note</h2>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className="w-full sm:w-auto bg-blue-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-700 transition-colors text-sm sm:text-base"
                    >
                      {processing ? (

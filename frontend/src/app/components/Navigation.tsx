      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {user && (
              <>
                <Link href="/student" className="px-4 py-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-xl font-medium transition-all duration-300 hover:scale-105">
                  Dashboard
                </Link>

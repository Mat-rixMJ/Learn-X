      ...
      <div className="max-w-6xl mx-auto pt-20 pb-12">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6 lg:pt-20">
            <h1 className="text-4xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
              Welcome Back!
            </h1>
            <p className="text-xl text-gray-600 max-w-lg mx-auto lg:mx-0">
              Unlock a world of interactive learning. Join thousands of students and teachers in our vibrant community.
            </p>
          ...
          <div className="w-full lg:w-5/12">
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100/50 backdrop-blur-lg">
              <h2 className="text-2xl font-outfit font-bold mb-6 text-gray-800">Sign in to your account</h2>
              {error && (
